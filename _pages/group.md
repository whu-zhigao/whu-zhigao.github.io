...
<div style="display: flex; justify-content: flex-start;">
  <div style="text-align: center; margin-left: 30px;">
    <img src="/images/team2023/lichangshi.jpg" alt="图片描述" style="border-radius: 50%;">
    <p style="margin-bottom: 0;">Changshi Li</p>
    <p style="margin-top: 0;">(2023~)</p>
  </div>
  <div style="text-align: center; margin-left: 30px;">
    <img src="/images/team2023/zhaochen.jpg" alt="图片描述" style="border-radius: 50%;">
...
<div style="display: flex; justify-content: flex-start;">
  <div style="text-align: center; margin-left: 30px;">
    <img src="/images/team2023/jinsong.jpg" alt="图片描述" style="border-radius: 50%;">
    <p style="margin-bottom: 0;">Song Jin</p>
    <p style="margin-top: 0;">(2023~)</p>
  </div>
  <div style="text-align: center; margin-left: 30px;">
    <img src="/images/team2023/xiuyang.jpg" alt="图片描述" style="border-radius: 50%;">
    <p style="margin-bottom: 0;">Yang Xiu</p>
    <p style="margin-top: 0;">(2023~)</p>
  </div>
  <div style="text-align: center; margin-left: 30px;">
    <img src="/images/team2023/xiepeichen.jpg" alt="图片描述" style="border-radius: 50%;">
...
<div style="display: flex; justify-content: flex-start;">
  <div style="text-align: center; margin-left: 30px;">
    <img src="/images/team2023/shuixirui.jpg" alt="图片描述" style="border-radius: 50%;">
    <p style="margin-bottom: 0;">Xirui Shui</p>
    <p style="margin-top: 0;">(2023~)</p>
  </div>
  <div style="text-align: center; margin-left: 30px;">
    <img src="/images/team2023/weixianyi.jpg" alt="图片描述" style="border-radius: 50%;">
  ...
  <div style="text-align: center; margin-left: 30px;">
    <img src="/images/team2023/xiaoxuan.jpg" alt="图片描述" style="border-radius: 50%;">
    <p style="margin-bottom: 0;">Xuan Xiao</p>
    <p style="margin-top: 0;">(2023~)</p>
  </div>
  <div style="text-align: center; margin-left: 30px;">
    <img src="/images/team2023/liyuqi.jpg" alt="图片描述" style="border-radius: 50%;">
...
<div style="display: flex; justify-content: flex-start;">
  <div style="text-align: center; margin-left: 30px;">
    <img src="/images/team2023/hepai.jpg" alt="图片描述" style="border-radius: 50%;">
    <p style="margin-bottom: 0;">Pai He</p>
    <p style="margin-top: 0;">(2023~)</p>
  </div>
  <div style="text-align: center; margin-left: 30px;">
    <img src="/images/team2023/weipengfei.jpg" alt="图片描述" style="border-radius: 50%;">
...
<div style="display: flex; justify-content: flex-start;">
  <div style="text-align: center; margin-left: 30px;">
    <img src="/images/team2023/yangyuanhua.jpg" alt="图片描述" style="border-radius: 50%;">
